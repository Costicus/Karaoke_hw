...
class TestGuest(unittest.TestCase):
    def setUp(self):
        self.guest1 = Guest("John", 30)
        self.guest2 = Guest("Lora", 29)

    def test_guests_in_rooms(self):
        self.assertEqual("John", self.guest1.name)
        self.assertEqual("Lora", self.guest2.name)

    def test_guests_age(self):
        self.assertEqual(30, self.guest1.age)
        self.assertEqual(29, self.guest2.age)
