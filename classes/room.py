class Room:
    def __init__(self, number_of_rooms, clients):
        self.number_of_rooms = number_of_rooms
        self.clients = clients
    
# def rooms(number_of_rooms):
...
def check_in_guest(self, guest):
    ...
    def find_if_any_person_has_a_fav_song_list(self):
        for guest in self.guests:
            if guest.cheer_for_song_name(self) != None:
                return guest.cheer_for_song_name(self)
        return None
